...
Perubahan utama:
- Content-Type otomatis untuk .m3u8, .mpd, .ts, .mp4.  
- Cache-Control no-cache untuk manifest supaya player selalu ambil versi terbaru.  
- Tetap meneruskan body secara streaming agar performa tinggi.  

Dengan ini, player seperti Shaka atau HLS.js akan lebih stabil saat ambil manifest dan segmen melalui proxy.  
